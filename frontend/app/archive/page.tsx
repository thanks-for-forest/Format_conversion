...
// 压缩包页（切片 8）：打包（多文件→ZIP）与解压（ZIP/TAR.GZ→文件列表）。
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ marginLeft: 8, padding: "8px 16px", borderRadius: 8, border: "none", background: "#2563eb", color: "#fff", cursor: "pointer" }}
        >
          打包下载
        </button>
      </section>
      ...
      {message && (
        <p style={{ marginTop: 12, fontSize: 14, color: message.includes("完成") ? "#059669" : "#dc2626" }}>
          {message}
          {pathUsed && (
