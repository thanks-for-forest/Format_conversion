...
export default function FilesToZipPage() {
  return (
    ...
    >
      <h1 style={{ fontSize: 28, margin: 0, color: "var(--ink)" }}>文件打包成 ZIP</h1>
      ...
      <section style={{ marginTop: 24, fontSize: 13, color: "var(--muted)" }}>
        <h2 style={{ fontSize: 15, color: "var(--ink)" }}>打包步骤</h2>
        ...
        <p style={{ lineHeight: 1.8, margin: "8px 0 0" }}>
          需要反向操作？试试{" "}
          <Link href="/convert/zip-to-files" style={{ color: "var(--brand)", fontWeight: 600 }}>
            在线解压 ZIP / TAR.GZ
          </Link>
          ；还想转换图片格式？看{" "}
